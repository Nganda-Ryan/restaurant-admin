        ...
        },
        {
          icon: `
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
              <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 13.5 2.25H15a2.25 2.25 0 0 1 2.25 2.25v8.906a2.25 2.25 0 0 1-2.25 2.25H6.75a2.25 2.25 0 0 1-2.25-2.25V4.5A2.25 2.25 0 0 1 6.75 2.25h1.5a2.25 2.25 0 0 1 2.023 1.5Zm0 0V4.5h-1.5V3.75h1.5Z" />
            </svg>
          `,
          label: 'Commandes',
          route: '/commande-list',
...
<template >
  <aside class="absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden duration-300 ease-linear lg:static lg:translate-x-0 bg-gradient-to-b from-olive-900 to-olive-800"
    ...
    <div class="flex items-center logo-wrapper gap-2 px-6 pt-3">
      <router-link to="/" class="flex items-center gap-8"> <!-- Augmentez le gap ici (4 = 1rem) -->
       <img :src="logoresto || require('@/assets/images/logo/restaurant-logo.png')" alt="Logo" class="rounded-full object-cover h-15 w-15" />
        <div class="flex flex-col items-end">
          <span class="text-lg font-semibold text-white">{{nameResto}}</span>
          <span class="text-xs text-gray-300">{{email}}</span>
        </div>
      </router-link>
